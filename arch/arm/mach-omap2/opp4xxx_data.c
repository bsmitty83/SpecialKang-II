...
#define OMAP4460_VDD_MPU_OPPNOC_UV    			950000
...
#endif
#ifdef CONFIG_OMAP_OCFREQ_1680
#define OMAP4460_VDD_MPU_OPPNITRO_UV_OC1680	1403000
#endif
#ifdef CONFIG_OMAP_OCFREQ_1850
#define OMAP4460_VDD_MPU_OPPNITRO_UV_OC1850	1410000
#endif

#ifdef CONFIG_OMAP_SMARTREFLEX_CUSTOM_SENSOR
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNOC_UV, 10000, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0, 0, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
...
#endif
#ifdef CONFIG_OMAP_OCFREQ_1680
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1680, 0, 0, 2708, 2476, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
#endif
#ifdef CONFIG_OMAP_OCFREQ_1850
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1850, 0, 0, 2920, 2666, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
#endif
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0, 0, 0),
};
#else
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNOC_UV, 10000, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
...
static struct omap_vdd_dep_volt omap446x_vdd_mpu_core_dep_data[] = {
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPNOC_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP50_UV},
...
#endif
#ifdef CONFIG_OMAP_OCFREQ_1680
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPNITRO_UV_OC1680, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
#endif
#ifdef CONFIG_OMAP_OCFREQ_1850
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPNITRO_UV_OC1850, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
#endif
};
...
#endif
#ifdef CONFIG_OMAP_OCFREQ_1680
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1680000000, OMAP4460_VDD_MPU_OPPNITRO_UV_OC1680),
#endif
#ifdef CONFIG_OMAP_OCFREQ_1850
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1850000000, OMAP4460_VDD_MPU_OPPNITRO_UV_OC1850),
#endif
...
#endif
#ifdef CONFIG_OMAP_OCFREQ_1680
		omap4_mpu_opp_enable(1680000000);
#endif
#ifdef CONFIG_OMAP_OCFREQ_1850
		omap4_mpu_opp_enable(1850000000);
#endif
